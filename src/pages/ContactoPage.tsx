          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className={`border rounded-3xl p-6 space-y-3 text-xs ${
              ...
              <div className={`flex items-center justify-between pb-2 border-b ${
                ...
                <span className="text-[#00A9A3] font-semibold">
                  <span>empresas</span><span className="text-[#00A9A3]">&#64;</span><span>nexotalentos.com</span>
                </span>
              </div>
              <div className={`flex items-center justify-between pb-2 border-b ${
                theme === 'dark' ? 'border-slate-800' : 'border-slate-100'
                ...
                <span className="text-blue-500 font-semibold">
                  <span>talento</span><span className="text-blue-500">&#64;</span><span>nexotalentos.com</span>
                </span>
              </div>
              <div className={`flex items-center justify-between pb-2 border-b ${
                theme === 'dark' ? 'border-slate-800' : 'border-slate-100'
                ...
                <span className="font-semibold">
                  <span>contacto</span><span className="text-slate-400">&#64;</span><span>nexotalentos.com</span>
                </span>
              </div>
