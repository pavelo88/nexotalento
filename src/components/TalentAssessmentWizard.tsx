    ...
    <section id="diagnostico-talento" className="py-12 sm:py-16 bg-slate-900/40 relative">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <SuccessModal 
          ...
          title="¡Diagnóstico Registrado con Éxito!"
          message={`Hemos generado tu hoja de ruta personalizada de atracción de talento para ${formData.companyName || 'tu empresa'}. Un Headhunter Sénior asignado revisará tu caso y te contactará en menos de 24 horas laborables.`}
        />
